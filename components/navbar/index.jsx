        ...
        <header className="bg-base-100 shadow-sm">
            <div className="navbar container mx-auto">
                ...
                <div className="navbar-end gap-2">
                    <Link aria-label="LinkedIn Link" target="_blank" href={LinksStr.linkedIn} className="btn btn-info btn-square rounded-lg">
                    ...
                    <Link aria-label="Github Link" target="_blank" href={LinksStr.github} className="btn btn-neutral btn-square rounded-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="w-8 h-8 fill-white" viewBox="0 0 30 30">
